...
class WebGLModel{
    constructor(gl,program,dim,primitiveType,coords,indices,colors,normals,tangents,textureCoords,textureName,illumAttrib = null){
        this.gl = gl;
...
class WebGLMeshModel extends WebGLModel{
    constructor(gl,program,dim,primitiveType,coords,indices,colors,normals,tangents,textureCoords,textureName,illumAttrib){
        super(gl,program,dim,primitiveType,coords,indices,colors,normals,tangents,textureCoords,textureName);
        this.illumAttrib = illumAttrib;
    }
    ...
    draw(){
        ...
        this.gl.uniform4fv(this.program["uMatAmbient"], this.illumAttrib.matAmbient);
        this.gl.uniform3fv(this.program["uKa"], this.illumAttrib.Ka);
        this.gl.uniform4fv(this.program["uMatDiffuse"], this.illumAttrib.matDiffuse);
        this.gl.uniform3fv(this.program["uKd"], this.illumAttrib.Kd);
        this.gl.uniform4fv(this.program["uMatSpecular"], this.illumAttrib.matSpecular);
        this.gl.uniform3fv(this.program["uKs"], this.illumAttrib.Ks);
        this.gl.uniform1f(this.program["uNs"], this.illumAttrib.Ns);
        this.gl.uniform1f(this.program["uD"], this.illumAttrib.D);
